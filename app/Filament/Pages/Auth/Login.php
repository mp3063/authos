...
class Login extends BaseLogin
{
    ...
    {
        // Get the default subheading from parent
        $defaultSubheading = parent::getSubheading();
        ...
        return new HtmlString(($defaultSubheading ? $defaultSubheading->toHtml() : '') . $socialSection);
    }
